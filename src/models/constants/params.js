...
export const paramTypes = Object.freeze({
  ...
  bat_rayConfidenceStep: { id: 704, name: 'Ray step confidence', groupId: bundleAdjustTypeId },
  bat_rayMinTiles: { id: 705, name: 'Ray min. tiles', groupId: bundleAdjustTypeId },
  bat_reproj: { id: 706, name: 'Reprojection', groupId: bundleAdjustTypeId },
  bat_reprojCap200: { id: 707, name: 'Reproj. cap 200', groupId: bundleAdjustTypeId },
  bat_reprojMinTiles: { id: 708, name: 'Reproj. min. tiles', groupId: bundleAdjustTypeId },
  bat_reprojNoCam: { id: 709, name: 'Reproj. nce', groupId: bundleAdjustTypeId },
  bat_reprojNoCamCap200: { id: 710, name: 'Reproj. nce 200', groupId: bundleAdjustTypeId },
