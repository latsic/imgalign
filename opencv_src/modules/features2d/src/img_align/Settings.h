...
namespace imgalign
{
  enum ParamType {
    ...
    // eBundleAdjustType_ray4 = 604,

    eBundleAdjustType_none = 701,
    eBundleAdjustType_ray = 702,
    eBundleAdjustType_rayBlacklist = 703,
    eBundleAdjustType_rayConfidenceStep = 704,
    eBundleAdjustType_rayMinTiles = 705,
    eBundleAdjustType_reproj = 706,
    eBundleAdjustType_reprojCap200 = 707,
    eBundleAdjustType_reprojMinTiles = 708,
    eBundleAdjustType_reprojNoCam = 709,
    eBundleAdjustType_reprojNoCamCap200 = 710,
